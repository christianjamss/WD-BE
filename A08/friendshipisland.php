...
$IslandQuery = "SELECT * FROM islandContents JOIN islandsOfPersonality ON islandContents.islandOfPersonalityID = islandsOfPersonality.islandOfPersonalityID WHERE islandsOfPersonality.islandOfPersonalityID = '3';";
$IslandResult = executeQuery($IslandQuery);

$ContentQuery = "SELECT * FROM islandContents WHERE islandOfPersonalityID = '3';";
